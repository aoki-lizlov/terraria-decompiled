...
namespace SteelSeries.GameSense
{
	...
	{
		// Token: 0x0600018A RID: 394 RVA: 0x000084F8 File Offset: 0x000066F8
		// Note: this type is marked as 'beforefieldinit'.
		static HIDCodes()
		{
			Dictionary<string, byte> dictionary = new Dictionary<string, byte>();
			dictionary.Add("None", 0);
			dictionary.Add("Tab", 43);
			dictionary.Add("Enter", 40);
			dictionary.Add("Pause", 72);
			dictionary.Add("CapsLock", 57);
			dictionary.Add("Space", 44);
			dictionary.Add("PageUp", 75);
			dictionary.Add("PageDown", 78);
			dictionary.Add("End", 77);
			dictionary.Add("Home", 74);
			dictionary.Add("Left", 80);
			dictionary.Add("Up", 82);
			dictionary.Add("Right", 79);
			dictionary.Add("Down", 81);
			dictionary.Add("Insert", 73);
			dictionary.Add("Delete", 76);
			dictionary.Add("Help", 117);
			dictionary.Add("D0", 39);
			dictionary.Add("D1", 30);
			dictionary.Add("D2", 31);
			dictionary.Add("D3", 32);
			dictionary.Add("D4", 33);
			dictionary.Add("D5", 34);
			dictionary.Add("D6", 35);
			dictionary.Add("D7", 36);
			dictionary.Add("D8", 37);
			dictionary.Add("D9", 38);
			dictionary.Add("A", 4);
			dictionary.Add("B", 5);
			dictionary.Add("C", 6);
			dictionary.Add("D", 7);
			...
			dictionary.Add("Y", 28);
			dictionary.Add("Z", 29);
			dictionary.Add("NumPad0", 98);
			dictionary.Add("NumPad1", 89);
			dictionary.Add("NumPad2", 90);
			dictionary.Add("NumPad3", 91);
			dictionary.Add("NumPad4", 92);
			dictionary.Add("NumPad5", 93);
			dictionary.Add("NumPad6", 94);
			dictionary.Add("NumPad7", 95);
			dictionary.Add("NumPad8", 96);
			dictionary.Add("NumPad9", 97);
			dictionary.Add("F1", 58);
			dictionary.Add("F2", 59);
			dictionary.Add("F3", 60);
			dictionary.Add("F4", 61);
			dictionary.Add("F5", 62);
			dictionary.Add("F6", 63);
			dictionary.Add("F7", 64);
			dictionary.Add("F8", 65);
			dictionary.Add("F9", 66);
			dictionary.Add("F10", 67);
			dictionary.Add("F11", 68);
			dictionary.Add("F12", 69);
			dictionary.Add("F13", 104);
			dictionary.Add("F14", 105);
			dictionary.Add("F15", 106);
			dictionary.Add("F16", 107);
			dictionary.Add("F17", 108);
			dictionary.Add("F18", 109);
			dictionary.Add("F19", 110);
			dictionary.Add("F20", 111);
			dictionary.Add("F21", 112);
			dictionary.Add("F22", 113);
			dictionary.Add("F23", 114);
			dictionary.Add("F24", 115);
			dictionary.Add("NumLock", 83);
			HIDCodes.XnaKeyNamesToSteelSeriesKeyIndex = dictionary;
		}

		// Token: 0x04000090 RID: 144
		public static readonly Dictionary<string, byte> XnaKeyNamesToSteelSeriesKeyIndex;
