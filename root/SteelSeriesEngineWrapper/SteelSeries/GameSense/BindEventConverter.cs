...
namespace SteelSeries.GameSense
{
	...
	public class BindEventConverter : fsDirectConverter<Bind_Event>
	{
		...
		protected override fsResult DoSerialize(Bind_Event model, Dictionary<string, fsData> serialized)
		{
			...
			{
				BindEventLocalizations bindEventLocalizations = new BindEventLocalizations
				{
					AvailableLocalizations = model.localizedDisplayNames
				};
				base.SerializeMember<BindEventLocalizations>(serialized, null, "localized_display_names", bindEventLocalizations);
			}
			return fsResult.Success;
		}

		// Token: 0x06000181 RID: 385 RVA: 0x000083DC File Offset: 0x000065DC
		public BindEventConverter()
		{
		}
	}
}
