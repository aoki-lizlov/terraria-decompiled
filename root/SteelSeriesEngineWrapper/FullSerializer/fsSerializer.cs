...
namespace FullSerializer
{
	...
	{
		// Token: 0x0600008C RID: 140 RVA: 0x000042F8 File Offset: 0x000024F8
		static fsSerializer()
		{
		...
		public fsSerializer()
		{
			...
			list.Add(new fsNullableConverter
			{
				Serializer = this
			});
			list.Add(new fsGuidConverter
			{
				Serializer = this
			});
			...
			list.Add(new fsIEnumerableConverter
			{
				Serializer = this
			});
			list.Add(new fsKeyValuePairConverter
			{
				Serializer = this
			});
			list.Add(new fsWeakReferenceConverter
			{
				Serializer = this
			});
			...
			List<fsObjectProcessor> list2 = new List<fsObjectProcessor>();
			list2.Add(new fsSerializationCallbackProcessor());
			this._processors = list2;
		...
		private fsBaseConverter GetConverter(Type type, Type overrideConverterType)
		{
			if (overrideConverterType != null)
			{
				...
				if (!this._cachedConverterTypeInstances.TryGetValue(overrideConverterType, ref fsBaseConverter))
				{
		...
		internal class fsLazyCycleDefinitionWriter
		{
			...
			// Token: 0x06000295 RID: 661 RVA: 0x00009C33 File Offset: 0x00007E33
