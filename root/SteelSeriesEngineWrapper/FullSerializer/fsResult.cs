...
namespace FullSerializer
{
	...
	public struct fsResult
	{
		...
		{
			fsResult fsResult = default(fsResult);
			fsResult._success = true;
			List<string> list = new List<string>();
			list.Add(warning);
			fsResult._messages = list;
			return fsResult;
		}
		...
		// Token: 0x0600008B RID: 139 RVA: 0x000042C8 File Offset: 0x000024C8
