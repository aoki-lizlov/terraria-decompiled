...
{
	// Token: 0x06000045 RID: 69 RVA: 0x000025DA File Offset: 0x000007DA
	internal static string GetString(string name, params object[] args)
	{
		return SR.GetString(CultureInfo.InvariantCulture, name, args);
	}

	// Token: 0x06000046 RID: 70 RVA: 0x000025E8 File Offset: 0x000007E8
	internal static string GetString(CultureInfo culture, string name, params object[] args)
	{
		return string.Format(culture, name, args);
	}

	// Token: 0x06000047 RID: 71 RVA: 0x000025CE File Offset: 0x000007CE
	internal static string GetString(string name)
	{
		return name;
	}

	// Token: 0x06000048 RID: 72 RVA: 0x000025F2 File Offset: 0x000007F2
	internal static string GetString(CultureInfo culture, string name)
	{
		return name;
	}

	// Token: 0x06000049 RID: 73 RVA: 0x000025F5 File Offset: 0x000007F5
	...
	// Token: 0x0600004A RID: 74 RVA: 0x00002608 File Offset: 0x00000808
	internal static string Format(string resourceFormat, object p1)
	{
		return string.Format(CultureInfo.InvariantCulture, resourceFormat, p1);
	}

	// Token: 0x0600004B RID: 75 RVA: 0x00002616 File Offset: 0x00000816
	internal static string Format(string resourceFormat, object p1, object p2)
	{
		return string.Format(CultureInfo.InvariantCulture, resourceFormat, p1, p2);
	}

	// Token: 0x0600004C RID: 76 RVA: 0x00002625 File Offset: 0x00000825
	...
	// Token: 0x0600004D RID: 77 RVA: 0x00002630 File Offset: 0x00000830
	internal static string Format(string resourceFormat, object p1, object p2, object p3)
	{
		return string.Format(CultureInfo.InvariantCulture, resourceFormat, p1, p2, p3);
	}

	// Token: 0x0600004E RID: 78 RVA: 0x000025CE File Offset: 0x000007CE
	internal static string GetResourceString(string str)
	{
		return str;
	}

	// Token: 0x0600004F RID: 79 RVA: 0x000025CE File Offset: 0x000007CE
