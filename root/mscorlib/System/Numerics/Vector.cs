...
namespace System.Numerics
{
	...
	public struct Vector<T> : IEquatable<Vector<T>>, IFormattable where T : struct
	{
		...
		// (get) Token: 0x060052CE RID: 21198 RVA: 0x001058EA File Offset: 0x00103AEA
		...
		// (get) Token: 0x060052CF RID: 21199 RVA: 0x001058F1 File Offset: 0x00103AF1
		...
		// (get) Token: 0x060052D0 RID: 21200 RVA: 0x001058F8 File Offset: 0x00103AF8
		...
		// (get) Token: 0x060052D1 RID: 21201 RVA: 0x001058FF File Offset: 0x00103AFF
		...
		// Token: 0x060052D2 RID: 21202 RVA: 0x00105908 File Offset: 0x00103B08
		...
		// Token: 0x060052D3 RID: 21203 RVA: 0x00105A90 File Offset: 0x00103C90
		[Intrinsic]
		...
		// Token: 0x060052D4 RID: 21204 RVA: 0x001064F2 File Offset: 0x001046F2
		[Intrinsic]
		...
		// Token: 0x060052D5 RID: 21205 RVA: 0x001064FC File Offset: 0x001046FC
		...
		// Token: 0x060052D6 RID: 21206 RVA: 0x0010667C File Offset: 0x0010487C
		...
		// Token: 0x060052D7 RID: 21207 RVA: 0x0010729B File Offset: 0x0010549B
		internal unsafe Vector(void* dataPointer)
		{
			this = new Vector<T>(dataPointer, 0);
		}

		// Token: 0x060052D8 RID: 21208 RVA: 0x001072A8 File Offset: 0x001054A8
		...
		// Token: 0x060052D9 RID: 21209 RVA: 0x0010768D File Offset: 0x0010588D
		private Vector(ref Register existingRegister)
		{
			this.register = existingRegister;
		}

		// Token: 0x060052DA RID: 21210 RVA: 0x0010769B File Offset: 0x0010589B
		[Intrinsic]
		...
		// Token: 0x060052DB RID: 21211 RVA: 0x001076A8 File Offset: 0x001058A8
		[Intrinsic]
		...
		// Token: 0x060052DD RID: 21213 RVA: 0x0010858F File Offset: 0x0010678F
		...
		// Token: 0x060052DE RID: 21214 RVA: 0x001085A8 File Offset: 0x001067A8
		[Intrinsic]
		...
		// Token: 0x060052DF RID: 21215 RVA: 0x00108DA0 File Offset: 0x00106FA0
		...
		// Token: 0x060052E0 RID: 21216 RVA: 0x0010981D File Offset: 0x00107A1D
		public override string ToString()
		{
			return this.ToString("G", CultureInfo.CurrentCulture);
		}

		// Token: 0x060052E1 RID: 21217 RVA: 0x0010982F File Offset: 0x00107A2F
		public string ToString(string format)
		{
			return this.ToString(format, CultureInfo.CurrentCulture);
		}

		// Token: 0x060052E2 RID: 21218 RVA: 0x00109840 File Offset: 0x00107A40
		...
		// Token: 0x060052E3 RID: 21219 RVA: 0x001098E0 File Offset: 0x00107AE0
		...
		// Token: 0x060052E4 RID: 21220 RVA: 0x0010A7BC File Offset: 0x001089BC
		public unsafe static Vector<T>operator -(Vector<T> left, Vector<T> right)
		{
			if (!Vector.IsHardwareAccelerated)
			{
		...
		// Token: 0x060052E5 RID: 21221 RVA: 0x0010B698 File Offset: 0x00109898
		public unsafe static Vector<T>operator *(Vector<T> left, Vector<T> right)
		{
			if (!Vector.IsHardwareAccelerated)
			{
		...
		// Token: 0x060052E6 RID: 21222 RVA: 0x0010C574 File Offset: 0x0010A774
		...
		// Token: 0x060052E7 RID: 21223 RVA: 0x0010D028 File Offset: 0x0010B228
		...
		// Token: 0x060052E8 RID: 21224 RVA: 0x0010DADC File Offset: 0x0010BCDC
		public unsafe static Vector<T>operator /(Vector<T> left, Vector<T> right)
		{
			if (!Vector.IsHardwareAccelerated)
			{
		...
		// Token: 0x060052E9 RID: 21225 RVA: 0x0010E9B5 File Offset: 0x0010CBB5
		public static Vector<T>operator -(Vector<T> value)
		{
			return Vector<T>.Zero - value;
		}

		// Token: 0x060052EA RID: 21226 RVA: 0x0010E9C4 File Offset: 0x0010CBC4
		[Intrinsic]
		public unsafe static Vector<T>operator &(Vector<T> left, Vector<T> right)
		{
			Vector<T> vector = default(Vector<T>);
		...
		// Token: 0x060052EB RID: 21227 RVA: 0x0010EA80 File Offset: 0x0010CC80
		[Intrinsic]
		public unsafe static Vector<T>operator |(Vector<T> left, Vector<T> right)
		{
			Vector<T> vector = default(Vector<T>);
		...
		// Token: 0x060052EC RID: 21228 RVA: 0x0010EB3C File Offset: 0x0010CD3C
		[Intrinsic]
		public unsafe static Vector<T>operator ^(Vector<T> left, Vector<T> right)
		{
			Vector<T> vector = default(Vector<T>);
		...
		// Token: 0x060052ED RID: 21229 RVA: 0x0010EBF8 File Offset: 0x0010CDF8
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Vector<T>operator ~(Vector<T> value)
		{
		...
		// Token: 0x060052EE RID: 21230 RVA: 0x0010EC05 File Offset: 0x0010CE05
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060052EF RID: 21231 RVA: 0x0010EC0F File Offset: 0x0010CE0F
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool operator !=(Vector<T> left, Vector<T> right)
		{
			return !(left == right);
		...
		// Token: 0x060052F0 RID: 21232 RVA: 0x0010EC1B File Offset: 0x0010CE1B
		[Intrinsic]
		...
		// Token: 0x060052F1 RID: 21233 RVA: 0x0010EC29 File Offset: 0x0010CE29
		[CLSCompliant(false)]
		[Intrinsic]
		...
		// Token: 0x060052F2 RID: 21234 RVA: 0x0010EC37 File Offset: 0x0010CE37
		[CLSCompliant(false)]
		[Intrinsic]
		...
		// Token: 0x060052F3 RID: 21235 RVA: 0x0010EC45 File Offset: 0x0010CE45
		[Intrinsic]
		...
		// Token: 0x060052F4 RID: 21236 RVA: 0x0010EC53 File Offset: 0x0010CE53
		[CLSCompliant(false)]
		[Intrinsic]
		...
		// Token: 0x060052F5 RID: 21237 RVA: 0x0010EC61 File Offset: 0x0010CE61
		[Intrinsic]
		...
		// Token: 0x060052F6 RID: 21238 RVA: 0x0010EC6F File Offset: 0x0010CE6F
		[CLSCompliant(false)]
		[Intrinsic]
		...
		// Token: 0x060052F7 RID: 21239 RVA: 0x0010EC7D File Offset: 0x0010CE7D
		[Intrinsic]
		...
		// Token: 0x060052F8 RID: 21240 RVA: 0x0010EC8B File Offset: 0x0010CE8B
		[Intrinsic]
		...
		// Token: 0x060052F9 RID: 21241 RVA: 0x0010EC99 File Offset: 0x0010CE99
		[Intrinsic]
		...
		// Token: 0x060052FA RID: 21242 RVA: 0x0010ECA8 File Offset: 0x0010CEA8
		[Intrinsic]
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060052FB RID: 21243 RVA: 0x0010FCB4 File Offset: 0x0010DEB4
		[Intrinsic]
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060052FC RID: 21244 RVA: 0x00110CC0 File Offset: 0x0010EEC0
		[Intrinsic]
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060052FD RID: 21245 RVA: 0x00111CCB File Offset: 0x0010FECB
		[Intrinsic]
		...
		// Token: 0x060052FE RID: 21246 RVA: 0x00111CE0 File Offset: 0x0010FEE0
		[Intrinsic]
		...
		// Token: 0x060052FF RID: 21247 RVA: 0x00111CF5 File Offset: 0x0010FEF5
		[Intrinsic]
		...
		// Token: 0x06005300 RID: 21248 RVA: 0x00111D0C File Offset: 0x0010FF0C
		[Intrinsic]
		...
		// Token: 0x06005301 RID: 21249 RVA: 0x001124D4 File Offset: 0x001106D4
		[Intrinsic]
		...
		// Token: 0x06005302 RID: 21250 RVA: 0x00113B24 File Offset: 0x00111D24
		[Intrinsic]
		...
		// Token: 0x06005303 RID: 21251 RVA: 0x00115174 File Offset: 0x00113374
		[Intrinsic]
		...
		// Token: 0x06005304 RID: 21252 RVA: 0x00115A00 File Offset: 0x00113C00
		[Intrinsic]
		...
		// Token: 0x06005305 RID: 21253 RVA: 0x001166FC File Offset: 0x001148FC
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x06005306 RID: 21254 RVA: 0x0011691C File Offset: 0x00114B1C
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x06005307 RID: 21255 RVA: 0x00116B3C File Offset: 0x00114D3C
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x06005308 RID: 21256 RVA: 0x00116D5C File Offset: 0x00114F5C
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x06005309 RID: 21257 RVA: 0x00116FDC File Offset: 0x001151DC
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x0600530A RID: 21258 RVA: 0x0011725C File Offset: 0x0011545C
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x0600530B RID: 21259 RVA: 0x001174DC File Offset: 0x001156DC
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x0600530C RID: 21260 RVA: 0x0011775C File Offset: 0x0011595C
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x0600530D RID: 21261 RVA: 0x00117908 File Offset: 0x00115B08
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x0600530E RID: 21262 RVA: 0x00117ACD File Offset: 0x00115CCD
