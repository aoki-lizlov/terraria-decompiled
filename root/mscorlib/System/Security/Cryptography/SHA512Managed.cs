...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x06003004 RID: 12292 RVA: 0x000B04CC File Offset: 0x000AE6CC
		...
		// Token: 0x06003005 RID: 12293 RVA: 0x000B0525 File Offset: 0x000AE725
		...
		// Token: 0x06003006 RID: 12294 RVA: 0x000B0555 File Offset: 0x000AE755
		...
		// Token: 0x06003007 RID: 12295 RVA: 0x000B0560 File Offset: 0x000AE760
		[SecuritySafeCritical]
		...
		// Token: 0x06003008 RID: 12296 RVA: 0x000B0568 File Offset: 0x000AE768
		...
		// Token: 0x06003009 RID: 12297 RVA: 0x000B0608 File Offset: 0x000AE808
		[SecurityCritical]
		...
		// Token: 0x0600300A RID: 12298 RVA: 0x000B0734 File Offset: 0x000AE934
		[SecurityCritical]
		...
		// Token: 0x0600300B RID: 12299 RVA: 0x000B0828 File Offset: 0x000AEA28
		[SecurityCritical]
		...
		// Token: 0x0600300C RID: 12300 RVA: 0x000B03AD File Offset: 0x000AE5AD
		private static ulong RotateRight(ulong x, int n)
		{
			return (x >> n) | (x << 64 - n);
		}

		// Token: 0x0600300D RID: 12301 RVA: 0x000B03BF File Offset: 0x000AE5BF
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x0600300E RID: 12302 RVA: 0x000AFC26 File Offset: 0x000ADE26
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x0600300F RID: 12303 RVA: 0x000B0B45 File Offset: 0x000AED45
		private static ulong Sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 28) ^ SHA512Managed.RotateRight(x, 34) ^ SHA512Managed.RotateRight(x, 39);
		}

		// Token: 0x06003010 RID: 12304 RVA: 0x000B0B61 File Offset: 0x000AED61
		private static ulong Sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 14) ^ SHA512Managed.RotateRight(x, 18) ^ SHA512Managed.RotateRight(x, 41);
		}

		// Token: 0x06003011 RID: 12305 RVA: 0x000B0B7D File Offset: 0x000AED7D
		private static ulong sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 1) ^ SHA512Managed.RotateRight(x, 8) ^ (x >> 7);
		}

		// Token: 0x06003012 RID: 12306 RVA: 0x000B0B92 File Offset: 0x000AED92
		private static ulong sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 19) ^ SHA512Managed.RotateRight(x, 61) ^ (x >> 6);
		}

		// Token: 0x06003013 RID: 12307 RVA: 0x000B0BAC File Offset: 0x000AEDAC
		[SecurityCritical]
		...
		// Token: 0x06003014 RID: 12308 RVA: 0x000B0C01 File Offset: 0x000AEE01
