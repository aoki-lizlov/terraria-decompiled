...
namespace Terraria.GameContent.RGB
{
	...
	{
		// Token: 0x06002597 RID: 9623 RVA: 0x00556259 File Offset: 0x00554459
		public WormShader()
		{
		}

		// Token: 0x06002598 RID: 9624 RVA: 0x005581BB File Offset: 0x005563BB
		...
		// Token: 0x06002599 RID: 9625 RVA: 0x005581EC File Offset: 0x005563EC
		...
		private void ProcessLowDetail(RgbDevice device, Fragment fragment, EffectDetailLevel quality, float time)
		{
			for (int i = 0; i < fragment.Count; i++)
			{
				...
				float num = Math.Max(0f, (float)Math.Sin((double)(time * -3f + canvasPositionOfIndex.X)));
				Vector4 vector = Vector4.Lerp(this._skinColor, this._eyeColor, num);
				fragment.SetColor(i, vector);
			}
		}

		// Token: 0x0600259A RID: 9626 RVA: 0x00558250 File Offset: 0x00556450
