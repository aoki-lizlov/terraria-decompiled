...
namespace Terraria.GameContent.Biomes
{
	...
	{
		// Token: 0x06003667 RID: 13927 RVA: 0x00626890 File Offset: 0x00624A90
		public override bool Place(Point origin, StructureMap structures, GenerationProgress progress)
		{
			Dictionary<ushort, int> dictionary = new Dictionary<ushort, int>();
			WorldUtils.Gen(new Point(origin.X - 25, origin.Y - 25), new Shapes.Rectangle(50, 50), new Actions.TileScanner(new ushort[] { 0, 59, 147, 1, 225 }).Output(dictionary));
			...
			for (int i = GenBase._random.Next(10, 15); i > 5; i--)
			{
				...
				WorldUtils.Gen(new Point(origin.X + num5, origin.Y + num4), new Shapes.Circle(i), Actions.Chain(new GenAction[]
				{
					...
					new Modifiers.OnlyTiles(new ushort[] { 147, 161, 224, 0, 1 }),
		...
		// Token: 0x06003668 RID: 13928 RVA: 0x0061F6EC File Offset: 0x0061D8EC
		public ThinIceBiome()
		{
		}
	}
