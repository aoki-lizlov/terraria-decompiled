...
namespace Terraria.GameContent.Biomes.CaveHouse
{
	...
	{
		// Token: 0x060036E4 RID: 14052 RVA: 0x0062BDAC File Offset: 0x00629FAC
		...
		// Token: 0x060036E5 RID: 14053 RVA: 0x0062BE24 File Offset: 0x0062A024
		protected override void AgeRoom(Rectangle room)
		{
			...
			WorldUtils.Gen(new Point(room.X + 1, room.Y), new Shapes.Rectangle(room.Width - 2, 1), Actions.Chain(new GenAction[]
			{
				...
				new Modifiers.OnlyTiles(new ushort[] { 367 }),
