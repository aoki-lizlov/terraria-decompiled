...
namespace Terraria.GameContent.Biomes.CaveHouse
{
	...
	{
		// Token: 0x0600369E RID: 13982 RVA: 0x006292CC File Offset: 0x006274CC
		...
		// Token: 0x0600369F RID: 13983 RVA: 0x00629358 File Offset: 0x00627558
		protected override void AgeRoom(Rectangle room)
		{
			...
			{
				new Modifiers.Dither(0.5),
				new Modifiers.OnlyTiles(new ushort[] { 397, 396 }),
