...
namespace Terraria.GameContent.Personalities
{
	...
	{
		// Token: 0x06003095 RID: 12437 RVA: 0x005BA6AE File Offset: 0x005B88AE
		public void ModifyShopPrice(HelperInfo info, ShopHelper shopHelperInstance)
		{
			AllPersonalitiesModifier.ModifyShopPrice_Relationships(info, shopHelperInstance);
		}

		// Token: 0x06003096 RID: 12438 RVA: 0x005BA6B8 File Offset: 0x005B88B8
		private static void ModifyShopPrice_Relationships(HelperInfo info, ShopHelper shopHelperInstance)
		{
			...
			if (info.npc.type == 663)
			{
				...
				{
					int num2 = Main.rand.Next(list.Count);
					int num3 = list[num2];
					list.RemoveAt(num2);
					shopHelperInstance.LoveNPCByTypeName(num3);
					num++;
				}
			}
		...
		// Token: 0x06003097 RID: 12439 RVA: 0x0000357B File Offset: 0x0000177B
