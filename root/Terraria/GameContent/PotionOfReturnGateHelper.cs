...
namespace Terraria.GameContent
{
	...
	{
		// Token: 0x06002427 RID: 9255 RVA: 0x0054B004 File Offset: 0x00549204
		...
		// Token: 0x06002428 RID: 9256 RVA: 0x0054B073 File Offset: 0x00549273
		public void Update()
		{
		...
		// Token: 0x06002429 RID: 9257 RVA: 0x0054B098 File Offset: 0x00549298
		public void SpawnReturnPortalDust()
		{
			...
			else if (Main.rand.Next(3) == 0)
			{
				if (Main.rand.Next(2) == 0)
				{
					...
					Dust dust3 = Dust.NewDustDirect(this._position - vector3 * 30f, 0, 0, Utils.SelectRandom<int>(Main.rand, new int[] { 86, 88 }), 0f, 0f, 0, default(Color), 1f);
				...
				Dust dust4 = Dust.NewDustDirect(this._position - vector4 * 30f, 0, 0, Utils.SelectRandom<int>(Main.rand, new int[] { 86, 88 }), 0f, 0f, 0, default(Color), 1f);
		...
		// Token: 0x0600242A RID: 9258 RVA: 0x0054B5AC File Offset: 0x005497AC
		public void DrawToDrawData(List<DrawData> drawDataList, int selectionMode)
		{
			...
			for (float num2 = 0f; num2 < 1f; num2 += 0.34f)
			{
				...
				drawData2.position += ((Main.GlobalTimeWrappedHourly / 5f + num2) * 6.2831855f).ToRotationVector2() * (x * 1f + 2f);
			...
			if (selectionMode != 0)
			{
				...
				if (num3 > 10)
				{
					...
					Rectangle rectangle2 = value.Frame(1, 8, 0, this._frameNumber, 0, 0);
					drawData = new DrawData(value, this._position - Main.screenPosition, new Rectangle?(rectangle2), selectionGlowColor, 0f, rectangle.Size() / 2f, 1f, SpriteEffects.None, 0f);
					drawDataList.Add(drawData);
				}
			}
		}
