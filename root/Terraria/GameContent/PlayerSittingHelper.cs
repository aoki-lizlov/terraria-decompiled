...
namespace Terraria.GameContent
{
	...
	{
		// Token: 0x0600238A RID: 9098 RVA: 0x0053EF94 File Offset: 0x0053D194
		...
		// Token: 0x0600238B RID: 9099 RVA: 0x0053F028 File Offset: 0x0053D228
		...
		// Token: 0x0600238C RID: 9100 RVA: 0x0053F08C File Offset: 0x0053D28C
		...
		// Token: 0x0600238D RID: 9101 RVA: 0x0053F1E0 File Offset: 0x0053D3E0
		...
		// Token: 0x0600238E RID: 9102 RVA: 0x0053F250 File Offset: 0x0053D450
		public void SitDown(Player player, int x, int y)
		{
			...
			Vector2 vector2;
			ExtraSeatInfo extraSeatInfo;
			if (!PlayerSittingHelper.GetSittingTargetInfo(player, x, y, out num, out vector, out vector2, out extraSeatInfo))
			{
				return;
			}
		...
		// Token: 0x0600238F RID: 9103 RVA: 0x0053F38C File Offset: 0x0053D58C
		public static bool GetSittingTargetInfo(Player player, int x, int y, out int targetDirection, out Vector2 playerSittingPosition, out Vector2 seatDownOffset, out ExtraSeatInfo extraInfo)
		{
			...
			bool flag2 = tileSafely.type == 15 && tileSafely.frameY / 40 == 27;
			seatDownOffset.Y = (float)(flag2.ToInt() * 4);
			if (tileSafely.frameY % 40 != 0)
			{
				num2--;
			}
