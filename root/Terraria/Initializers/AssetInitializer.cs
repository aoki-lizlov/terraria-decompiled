...
namespace Terraria.Initializers
{
	...
	{
		// Token: 0x06001572 RID: 5490 RVA: 0x004C4B10 File Offset: 0x004C2D10
		public static void CreateAssetServices(GameServiceContainer services)
		{
			...
			assetReaderCollection.RegisterReader(new PngReader(XnaExtensions.Get<IGraphicsDeviceService>(services).GraphicsDevice), new string[] { ".png" });
			assetReaderCollection.RegisterReader(new XnbReader(services), new string[] { ".xnb" });
		...
		// Token: 0x06001573 RID: 5491 RVA: 0x004C4BEC File Offset: 0x004C2DEC
		...
		// Token: 0x06001574 RID: 5492 RVA: 0x004C4C18 File Offset: 0x004C2E18
		public static ResourcePackList CreateResourcePackList(IServiceProvider services)
		{
			...
			return ResourcePackList.FromJson(jarray, services, text);
		}

		// Token: 0x06001575 RID: 5493 RVA: 0x004C4C38 File Offset: 0x004C2E38
		public static ResourcePackList CreatePublishableResourcePacksList(IServiceProvider services)
		{
			JArray jarray;
			string text;
			AssetInitializer.GetResourcePacksFolderPathAndConfirmItExists(out jarray, out text);
			return ResourcePackList.Publishable(jarray, services, text);
		}

		// Token: 0x06001576 RID: 5494 RVA: 0x004C4C56 File Offset: 0x004C2E56
		...
		// Token: 0x06001577 RID: 5495 RVA: 0x004C4C88 File Offset: 0x004C2E88
		...
		// Token: 0x06001578 RID: 5496 RVA: 0x004C4D79 File Offset: 0x004C2F79
		public static void Load(bool asyncLoad)
		{
			int num = (asyncLoad ? 2 : 1);
			AssetInitializer.LoadTextures(num);
			AssetInitializer.LoadRenderTargetAssets(num);
			AssetInitializer.LoadSounds(num);
			AssetInitializer.LoadFonts(num);
		}

		// Token: 0x06001579 RID: 5497 RVA: 0x004C4D9C File Offset: 0x004C2F9C
		...
		// Token: 0x0600157A RID: 5498 RVA: 0x004C4DFD File Offset: 0x004C2FFD
		private static void LoadSounds(AssetRequestMode mode)
		{
			SoundEngine.Load(Main.instance.Services);
		}

		// Token: 0x0600157B RID: 5499 RVA: 0x004C4E0E File Offset: 0x004C300E
		...
		// Token: 0x0600157C RID: 5500 RVA: 0x004C4E40 File Offset: 0x004C3040
		...
		// Token: 0x0600157D RID: 5501 RVA: 0x004C4E50 File Offset: 0x004C3050
		...
		// Token: 0x0600157E RID: 5502 RVA: 0x004C6C5B File Offset: 0x004C4E5B
