...
namespace Terraria.Initializers
{
	...
	{
		// Token: 0x060015AB RID: 5547 RVA: 0x004CC638 File Offset: 0x004CA838
		public static void Load()
		{
			...
			Filters.Scene["Sandstorm"] = new Filter(new SandstormShaderData("FilterSandstormForeground").UseColor(1.1f, 1f, 0.5f).UseSecondaryColor(0.7f, 0.5f, 0.3f).UseImage("Images/Misc/noise", 0, null)
				.UseIntensity(0.4f), EffectPriority.High);
			Overlays.Scene["Sandstorm"] = new SimpleOverlay("Images/Misc/noise", new SandstormShaderData("FilterSandstormBackground").UseColor(1.1f, 1f, 0.5f).UseSecondaryColor(0.7f, 0.5f, 0.3f).UseImage("Images/Misc/noise", 0, null)
				.UseIntensity(0.4f), EffectPriority.High, RenderLayers.Landscape);
			Filters.Scene["Blizzard"] = new Filter(new BlizzardShaderData("FilterBlizzardForeground").UseColor(1f, 1f, 1f).UseSecondaryColor(0.7f, 0.7f, 1f).UseImage("Images/Misc/noise", 0, null)
				.UseIntensity(0.4f)
				.UseImageScale(new Vector2(3f, 0.75f), 0), EffectPriority.High);
			Overlays.Scene["Blizzard"] = new SimpleOverlay("Images/Misc/noise", new BlizzardShaderData("FilterBlizzardBackground").UseColor(1f, 1f, 1f).UseSecondaryColor(0.7f, 0.7f, 1f).UseImage("Images/Misc/noise", 0, null)
				.UseIntensity(0.4f)
				.UseImageScale(new Vector2(3f, 0.75f), 0), EffectPriority.High, RenderLayers.Landscape);
		...
		// Token: 0x060015AC RID: 5548 RVA: 0x004CCCC4 File Offset: 0x004CAEC4
