...
namespace Terraria
{
	...
	{
		// Token: 0x06000176 RID: 374 RVA: 0x00011600 File Offset: 0x0000F800
		...
		// Token: 0x06000177 RID: 375 RVA: 0x000116C8 File Offset: 0x0000F8C8
		...
		// Token: 0x06000178 RID: 376 RVA: 0x0001171C File Offset: 0x0000F91C
		...
		// Token: 0x06000179 RID: 377 RVA: 0x00011770 File Offset: 0x0000F970
		...
		{
			bool flag = false;
			int num = Main.MaxWorldViewSize.X / 16;
			Point point = arenaCenter.ToTileCoordinates();
			xLeftEnd = (xRightEnd = point);
			int num2;
			int num3;
			Collision.ExpandVertically(point.X, point.Y, out num2, out num3, 0, 4);
			point.Y = num3;
			if (flag)
			{
			...
			int num4;
			Point point2;
			StrayMethods.SendWalker(point, walkerHeightInTiles, -1, out num4, out point2, num, flag);
			int num5;
			Point point3;
			StrayMethods.SendWalker(point, walkerHeightInTiles, 1, out num5, out point3, num, flag);
			point2.X++;
			point3.X--;
			if (flag)
			{
		...
		// Token: 0x0600017A RID: 378 RVA: 0x00011858 File Offset: 0x0000FA58
		...
		// Token: 0x0600017B RID: 379 RVA: 0x0000357B File Offset: 0x0000177B
		public StrayMethods()
		{
		}
	}
