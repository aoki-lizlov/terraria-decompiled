...
namespace Terraria.ID
{
	...
	public class ItemID
	{
		// Token: 0x06001F52 RID: 8018 RVA: 0x00516F70 File Offset: 0x00515170
		...
		// Token: 0x06001F53 RID: 8019 RVA: 0x005196B0 File Offset: 0x005178B0
		...
		// Token: 0x06001F54 RID: 8020 RVA: 0x005198AC File Offset: 0x00517AAC
		...
		// Token: 0x06001F55 RID: 8021 RVA: 0x0000357B File Offset: 0x0000177B
		public ItemID()
		{
		}

		// Token: 0x06001F56 RID: 8022 RVA: 0x005199DD File Offset: 0x00517BDD
		...
		{
			// Token: 0x06004151 RID: 16721 RVA: 0x006A1CD8 File Offset: 0x0069FED8
			public BannerEffect(float strength = 1f)
			{
				float num = 1f + strength * 0.5f;
				float num2 = 1f + strength;
				this.DamageDealt = new GameDifficultyData.LinearCurve(new GameDifficultyData.LinearCurve.Key[]
				{
					new GameDifficultyData.LinearCurve.Key(GameDifficultyLevel.Classic, num),
					new GameDifficultyData.LinearCurve.Key(GameDifficultyLevel.Expert, num2)
				});
				float num3 = 1f / (strength + 1f);
				float num4 = (1f + num3) / 2f;
				this.DamageReceived = new GameDifficultyData.LinearCurve(new GameDifficultyData.LinearCurve.Key[]
				{
					new GameDifficultyData.LinearCurve.Key(GameDifficultyLevel.Classic, num4),
					new GameDifficultyData.LinearCurve.Key(GameDifficultyLevel.Expert, num3)
				});
				this.Enabled = strength != 0f;
			}

			// Token: 0x06004152 RID: 16722 RVA: 0x006A1D92 File Offset: 0x0069FF92
			...
			// Token: 0x06004153 RID: 16723 RVA: 0x006A1DA9 File Offset: 0x0069FFA9
			// Note: this type is marked as 'beforefieldinit'.
			static BannerEffect()
			{
			}
		...
		public class Sets
		{
			// Token: 0x06004154 RID: 16724 RVA: 0x006A1DCC File Offset: 0x0069FFCC
			...
			// Token: 0x06004155 RID: 16725 RVA: 0x0000357B File Offset: 0x0000177B
			public Sets()
			{
			}

			// Token: 0x06004156 RID: 16726 RVA: 0x006A1E40 File Offset: 0x006A0040
			// Note: this type is marked as 'beforefieldinit'.
			static Sets()
			{
			}
			...
			public static bool[] DualEquipArmor = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 205, 5004, 4955 });

			// Token: 0x04006E9A RID: 28314
			public static bool[] ReceivesDiagonalCorrectionAsFakeFish = ItemID.Sets.Factory.CreateBoolSet(true, new int[] { 2342 });

			// Token: 0x04006E9B RID: 28315
			public static bool[] ShootsOnUseRelease = ItemID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				198, 3764, 200, 3766, 4258, 4259, 201, 3767, 199, 3765,
				203, 3769, 202, 3768, 5535, 5536, 5670, 5671, 671, 3772,
				3352
			});

			// Token: 0x04006E9C RID: 28316
			public static bool[] NoMeleeSpeedBonus = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 3821 });
			...
			{
				318, 312, 173, 174, 175, 4422, 2701, 205, 206, 207,
				1128, 2340, 2739, 2492, 1127, 85, 581, 582
			});

			// Token: 0x04006E9E RID: 28318
			public static bool[] ItemsThatAllowRepeatedRightClick = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 3384, 3858, 3852 });
			...
			{
				168, 2586, 3116, 166, 235, 3115, 167, 2896, 3547, 3196,
				4423, 1130, 1168, 4824, 4825, 4826, 4827, 4908, 4909, 5594,
				5595
			});

			// Token: 0x04006EA0 RID: 28320
			public static bool[] RapidAttackBonusDamage = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 2608, 3349, 672 });
			...
			{
				58, 184, 1734, 1735, 1867, 1868, 3453, 3454, 3455, 4143,
				5013, 6135, 6136, 6143
			});
			...
			{
				5363, 5365, 5366, 5367, 5368, 5369, 5370, 5371, 5372, 5373,
				5376, 5375, 5374, 3988, 5384, 5532, 5533, 5545, 5546
			});

			// Token: 0x04006EA3 RID: 28323
			public static bool[] CanBeExtractinated = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 424, 1103, 2339, 2338, 2337, 1124, 5395, 4090, 173 });

			// Token: 0x04006EA4 RID: 28324
			public static bool[] UsesBetterMeleeItemLocation = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 426 });

			// Token: 0x04006EA5 RID: 28325
			public static bool[] WorksInVoidBag = ItemID.Sets.Factory.CreateBoolSet(true, new int[] { 4346, 5095 });

			// Token: 0x04006EA6 RID: 28326
			public static bool[] GrassSeeds = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 62, 59, 2171, 369, 195, 194, 5214 });

			// Token: 0x04006EA7 RID: 28327
			public static bool[] Moss = ItemID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				4349, 4350, 4351, 4352, 4353, 4354, 4377, 4378, 4389, 5127,
				5128
			});
			...
			{
				3460, 947, 947, 1106, 1106, 366, 366, 1105, 1105, 365,
				365, 1104, 1104, 364, 364, 702, 702, 13, 13, 701,
				701, 14, 14, 700, 700, 11, 11, 699, 699, 12,
				12, 133, 133, 3, 3, 2, 5574, 5575, 182, 178,
				178, 179, 179, 177, 177, 180, 180, 181, 181, 133,
				4843, 182, 4836, 182, 4842, 178, 4835, 178, 4841, 179,
				4834, 179, 4840, 177, 4833, 177, 4832, 180, 4839, 180,
				4838, 181, 4831, 181, 4844, 999, 4837, 999, 620, 9,
				619, 9, 911, 9, 621, 9, 2503, 9, 2504, 9,
				2260, 9, 1729, 9, 5215, 9, 9, 2, 3271, 169,
				3272, 169, 3276, 370, 3274, 370, 3339, 408, 3338, 408,
				3277, 1246, 3275, 1246, 1127, 1124, 1125, 1124, 4503, 5363,
				30, 5546, 1723, 5545, 134, 5417, 137, 5419, 139, 5421,
				141, 5423, 143, 5425, 145, 5427, 415, 5429, 416, 5431,
				192, 5433, 214, 5435, 135, 5365, 1379, 5367, 1378, 5366,
				140, 5368, 1381, 5370, 1380, 5369, 138, 5371, 1383, 5373,
				1382, 5372, 1102, 5376, 3340, 5375, 3273, 5374, 664, 593,
				593, 5349, 3982, 3203, 3983, 3204, 3984, 3205, 3985, 3206,
				4406, 4405, 3981, 2336, 3986, 3207, 3980, 2335, 3987, 3208,
				4878, 4877, 4408, 4407, 5003, 5002, 3979, 2334, 3064, 5381,
				3086, 3081, 3081, 3086, 1534, 1529, 1535, 1530, 1536, 1531,
				1537, 1532, 4714, 4712, 1533, 1528, 206, 207, 207, 1128,
				1128, 206, 832, 4281, 5295, 5519, 5519, 5295, 5438, 5518,
				3818, 3824, 3824, 3832, 3832, 3829, 3829, 3818, 3819, 3825,
				3825, 3833, 3833, 3830, 3830, 3819, 3820, 3826, 3826, 3834,
				3834, 3831, 3831, 3820, 960, 228, 961, 229, 962, 230,
				228, 960, 229, 961, 230, 962, 956, 102, 957, 101,
				958, 100, 102, 956, 101, 957, 100, 958, 959, 151,
				151, 959, 955, 92, 92, 955, 954, 90, 90, 954,
				3093, 4345, 4345, 3093, 215, 5346, 5356, 5346, 3000, 5482,
				5482, 2999, 2999, 3000, 332, 2196, 411, 410, 410, 411,
				1725, 276, 276, 1725, 2886, 66, 67, 66, 195, 194,
				194, 195, 4389, 5128, 4377, 5128, 4378, 5128, 4354, 5128,
				5127, 5128, 8, 5353, 427, 5353, 3004, 5353, 523, 5353,
				433, 5353, 429, 5353, 974, 5353, 1333, 5353, 1245, 5353,
				3114, 5353, 430, 5353, 3045, 5353, 428, 5353, 2274, 5353,
				431, 5353, 432, 5353, 4383, 5353, 4384, 5353, 4385, 5353,
				4386, 5353, 4387, 5353, 4388, 5353, 5293, 5353, 966, 5357,
				52, 5347, 280, 277, 1304, 215, 40, 5348, 265, 5348,
				931, 5380, 1614, 5380, 848, 857, 857, 848, 866, 934,
				934, 866, 532, 5355, 3225, 159, 3120, 3096, 3096, 3037,
				3037, 3120, 2373, 2374, 2374, 2375, 2375, 2373, 855, 3033,
				854, 855, 3033, 854, 490, 491, 491, 489, 489, 2998,
				2998, 490, 892, 886, 886, 892, 885, 887, 887, 885,
				891, 890, 890, 891, 893, 889, 889, 893, 888, 3781,
				3781, 888, 1322, 906, 906, 1322, 351, 353, 3187, 3188,
				3188, 3189, 3189, 3187, 531, 5336, 29, 5337, 1291, 5338,
				109, 5339, 4414, 5340, 2895, 5341, 2222, 5343, 4009, 5342,
				4282, 5342, 4290, 5342, 4291, 5342, 4293, 5342, 4286, 5342,
				4295, 5342, 4284, 5342, 4289, 5342, 4285, 5342, 4296, 5342,
				4292, 5342, 4294, 5342, 4283, 5342, 4287, 5342, 4288, 5342,
				4297, 5342, 5278, 5342, 5277, 5342, 3186, 5492, 2693, 5493,
				60, 5, 2887, 5, 1326, 5335, 779, 5134, 3031, 5364,
				5364, 3031, 2610, 5495, 782, 784, 784, 782, 1146, 1147,
				1147, 1148, 1148, 1149, 1149, 1146, 2261, 2262, 2262, 2261,
				4907, 4871, 4871, 4907, 3015, 3016, 3016, 3015, 953, 975,
				975, 953, 4919, 5653, 4916, 5653, 4875, 5653, 4921, 5653,
				4918, 5653, 4876, 5653, 4920, 5653, 4917, 5653, 4951, 5653,
				5652, 5653, 5523, 5654, 5654, 5523, 4956, 5669, 136, 1390,
				1390, 1391, 1391, 1392, 1392, 1393, 1393, 1394, 1394, 1395,
				1395, 136, 3621, 5674, 3633, 5675, 3634, 5676, 3635, 5677,
				3636, 5678, 3637, 5679, 824, 5996, 5996, 824, 576, 6146,
				825, 5997, 5997, 825
			});

			// Token: 0x04006EA9 RID: 28329
			public static int[] ShimmerCountsAsItem = ItemID.Sets.Factory.CreateIntSet(-1, new int[] { 5358, 5437, 5361, 5437, 5360, 5437, 5359, 5437, 5455, 5323 });

			// Token: 0x04006EAA RID: 28330
			public static int[] ShimmerCountsAsItemForDecraft = ItemID.Sets.Factory.CreateIntSet(-1, new int[] { 5669, 4956 });

			// Token: 0x04006EAB RID: 28331
			public static bool[] ShimmerPostMoonlord = ItemID.Sets.Factory.CreateBoolSet(new int[] { 1326, 779, 3031, 5364, 784, 782 });

			// Token: 0x04006EAC RID: 28332
			public static int[] OverflowProtectionTimeOffset = ItemID.Sets.Factory.CreateIntSet(0, new int[]
			{
				2, 200, 3, 150, 61, 150, 836, 150, 409, 150,
				593, 200, 664, 100, 834, 100, 833, 100, 835, 100,
				169, 100, 370, 100, 1246, 100, 408, 100, 3271, 150,
				3277, 150, 3339, 150, 3276, 150, 3272, 150, 3274, 150,
				3275, 150, 3338, 150, 176, 100, 172, 200, 424, 50,
				1103, 50, 3087, 100, 3066, 100
			});
			...
			{
				50, true, 3199, true, 3124, true, 2350, true, 2351, true,
				29, true, 109, true, 1291, true, 4870, true, 5358, true,
				5359, true, 5360, true, 5361, true, 4263, true, 4819, true
			});

			// Token: 0x04006EAF RID: 28335
			public static bool?[] ForcesBreaksSleeping = ItemID.Sets.Factory.CreateCustomSet<bool?>(null, new object[] { 1991, true, 4821, true, 3183, true });

			// Token: 0x04006EB0 RID: 28336
			public static bool[] SkipsInitialUseSound = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 2350, 4870 });
			...
			public static bool[] UsesCursedByPlanteraTooltip = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 1533, 1534, 1535, 1536, 1537, 4714 });

			// Token: 0x04006EB3 RID: 28339
			public static bool[] IsAKite = ItemID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				4367, 4368, 4369, 4370, 4371, 4379, 4610, 4611, 4612, 4613,
				4648, 4649, 4650, 4651, 4669, 4670, 4671, 4674, 4675, 4676,
				4677, 4681, 4683, 4684
			});
			...
			public static bool[] PlaceTileOnAltUse = ItemID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				4367, 4368, 4369, 4370, 4371, 4379, 4610, 4611, 4612, 4613,
				4648, 4649, 4650, 4651, 4669, 4670, 4671, 4674, 4675, 4676,
				4677, 4681, 4683, 4684, 261, 1338, 1992, 1994, 1995, 1996,
				1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2006, 2007,
				2015, 2016, 2017, 2018, 2019, 2121, 2122, 2123, 2156, 2157,
				2205, 2673, 2740, 2889, 2890, 2891, 2892, 2893, 2894, 2895,
				3191, 3192, 3193, 3194, 3563, 3564, 4068, 4069, 4070, 4274,
				4334, 4335, 4336, 4337, 4338, 4339, 4340, 4359, 4361, 4362,
				4363, 4373, 4374, 4375, 4395, 4418, 4419, 4464, 4465, 4480,
				4482, 4831, 4832, 4833, 4834, 4835, 4836, 4837, 4838, 4839,
				4840, 4841, 4842, 4843, 4844, 4845, 4847, 4849, 4961, 5132,
				5212, 5300, 5311, 5312, 5313, 5350, 5511
			});

			// Token: 0x04006EB5 RID: 28341
			public static bool?[] ForceConsumption = ItemID.Sets.Factory.CreateCustomSet<bool?>(null, new object[]
			{
				2350, false, 4870, false, 2351, false, 2756, false, 4343, true,
				4344, true
			});
			...
			{
				267, 1307, 562, 563, 564, 565, 566, 567, 568, 569,
				570, 571, 572, 573, 574, 576, 1596, 1597, 1598, 1599,
				1600, 1601, 1602, 1603, 1604, 1605, 1606, 1607, 1608, 1609,
				1610, 1963, 1964, 1965, 2742, 3044, 3235, 3236, 3237, 3370,
				3371, 3796, 3869, 4077, 4078, 4079, 4080, 4081, 4082, 4237,
				4356, 4357, 4358, 4421, 4606, 4979, 4985, 4990, 4991, 4992,
				5006, 5014, 5015, 5016, 5017, 5018, 5019, 5020, 5021, 5022,
				5023, 5024, 5025, 5026, 5027, 5028, 5029, 5030, 5031, 5032,
				5033, 5034, 5035, 5036, 5037, 5038, 5039, 5040, 5044, 5112,
				5362, 5538, 5578, 5579, 5580, 5581, 5582, 5637, 5638, 5639,
				6144, 6145, 6146
			});
			...
			public static bool[] IgnoresEncumberingStone = ItemID.Sets.Factory.CreateBoolSet(new int[] { 58, 184, 1734, 1735, 1867, 1868, 3453, 3454, 3455, 4143 });

			// Token: 0x04006EC0 RID: 28352
			public static float[] ToolTipDamageMultiplier = ItemID.Sets.Factory.CreateFloatSet(1f, new float[]
			{
				162f, 2f, 801f, 2f, 163f, 2f, 220f, 2f, 389f, 2f,
				1259f, 2f, 4272f, 2f, 5011f, 2f, 5012f, 2f, 5526f, 2f
			});

			// Token: 0x04006EC1 RID: 28353
			public static bool[] IsAPickup = ItemID.Sets.Factory.CreateBoolSet(new int[] { 58, 184, 1734, 1735, 1867, 1868, 3453, 3454, 3455, 4143 });

			// Token: 0x04006EC2 RID: 28354
			public static bool[] IsDrill = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				388, 1231, 385, 386, 2779, 1196, 1189, 2784, 3464, 1203,
				2774, 579
			});
			...
			{
				387, 3098, 1232, 383, 384, 2778, 1197, 1190, 2783, 3463,
				1204, 2773, 2342, 579
			});

			// Token: 0x04006EC4 RID: 28356
			public static bool[] IsPaintScraper = ItemID.Sets.Factory.CreateBoolSet(new int[] { 1100, 1545 });
			...
			{
				4672, 4679, 4680, 4678, 4913, 4912, 4911, 4914, 5074, 5473,
				5474, 5475, 5476, 5477, 5478, 5479, 5480, 5688
			});
			...
			public static bool[] IsFood = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				...
				2425, 2426, 2427, 3195, 3532, 4009, 4010, 4011, 4012, 4013,
				4014, 4015, 4016, 4017, 4018, 4019, 4020, 4021, 4022, 4023,
				4024, 4025, 4026, 4027, 4028, 4029, 4030, 4031, 4032, 4033,
				4034, 4035, 4036, 4037, 967, 969, 4282, 4283, 4284, 4285,
				4286, 4287, 4288, 4289, 4290, 4291, 4292, 4293, 4294, 4295,
				4296, 4297, 4403, 4411, 4614, 4615, 4616, 4617, 4618, 4619,
				4620, 4621, 4622, 4623, 4624, 4625, 5009, 5042, 5041, 5092,
				5093, 5275, 5277, 5278, 5537, 5645
			});
			...
			public static Color[][] DrinkParticleColors = ItemID.Sets.Factory.CreateCustomSet<Color[]>(new Color[0], new object[]
			{
				...
				2266,
				new Color[] { new Color(233, 233, 218) * 0.3f },
				4018,
				new Color[]
				{
			...
			{
				3838, 1000, 3845, 200, 3837, 500, 3844, 200, 3843, 50,
				3839, 150, 3840, 100, 3842, 200, 3841, 100, 3846, 50,
				2971, 150, 2982, 150, 2931, 100, 2961, 100, 2994, 100,
				2985, 10, 4541, 10, 2969, 10, 2986, 10, 2915, 10,
				4602, 10, 4542, 25, 4543, 25, 4546, 25, 4545, 25,
				2901, 25, 2902, 25, 1631, 25, 2913, 25, 4688, 25,
				3390, 25, 4973, 25, 4974, 25, 4975, 25, 2934, 25,
				1670, 25, 1694, 25, 2958, 25, 2960, 25, 3441, 25,
				3780, 25, 3397, 25, 3403, 25
			});

			// Token: 0x04006ECD RID: 28365
			public static bool[] CanFishInLava = ItemID.Sets.Factory.CreateBoolSet(new int[] { 2422 });

			// Token: 0x04006ECE RID: 28366
			public static bool[] IsLavaBait = ItemID.Sets.Factory.CreateBoolSet(new int[] { 4849, 4845, 4847 });

			// Token: 0x04006ECF RID: 28367
			public static bool[] FakeFishInanimate = ItemID.Sets.Factory.CreateBoolSet(false, new int[] { 2423 });

			// Token: 0x04006ED0 RID: 28368
			public static bool[] IsBasicFish = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				2303, 2299, 2290, 2436, 2317, 2305, 2304, 2313, 2318, 2312,
				4401, 2306, 2308, 2437, 2319, 2314, 2302, 2315, 2438, 2307,
				2310, 2301, 4402, 2298, 2316, 2309, 2321, 2297, 2300, 2311
			});

			// Token: 0x04006ED1 RID: 28369
			public static bool[] IsFishingCrate = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				2334, 2335, 2336, 3203, 3204, 3205, 3206, 3207, 3208, 4405,
				4407, 4877, 5002, 3979, 3980, 3981, 3982, 3983, 3984, 3985,
				3986, 3987, 4406, 4408, 4878, 5003
			});

			// Token: 0x04006ED2 RID: 28370
			public static bool[] IsFishingCrateHardmode = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				3979, 3980, 3981, 3982, 3983, 3984, 3985, 3986, 3987, 4406,
				4408, 4878, 5003
			});
			...
			{
				5507, 5502, 5485, 5484, 5506, 5503, 5534, 5499, 5500, 5505,
				5501, 5504, 5508, 5509, 215
			});

			// Token: 0x04006ED4 RID: 28372
			public static bool[] CanBePlacedOnWeaponRacks = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				3196, 166, 235, 3115, 167, 2896, 3547, 580, 937, 4423,
				4824, 4825, 4826, 4827, 4908, 4909, 5594, 5595, 4094, 4039,
				4092, 4093, 4587, 4588, 4589, 4590, 4591, 4592, 4593, 4594,
				4595, 4596, 4597, 4598, 905, 1326, 5335, 2272, 2610, 5495,
				3384, 3225, 2303, 2299, 2290, 2317, 2305, 2304, 2313, 2318,
				2312, 2306, 2308, 2319, 2314, 2302, 2315, 2307, 2310, 2301,
				2298, 2316, 2309, 2321, 2297, 2300, 2311, 2420, 2438, 2437,
				2436, 4401, 4402, 2475, 2476, 2450, 2477, 2478, 2451, 2479,
				2480, 2452, 2453, 2481, 2454, 2482, 2483, 2455, 2456, 2457,
				2458, 2459, 2460, 2484, 2472, 2461, 2462, 2463, 2485, 2464,
				2465, 2486, 2466, 2467, 2468, 2487, 2469, 2488, 2470, 2471,
				2473, 2474, 4393, 4394
			});
			...
			{
				2475, 2476, 2450, 2477, 2478, 2451, 2479, 2480, 2452, 2453,
				2481, 2454, 2482, 2483, 2455, 2456, 2457, 2458, 2459, 2460,
				2484, 2472, 2461, 2462, 2463, 2485, 2464, 2465, 2486, 2466,
				2467, 2468, 2487, 2469, 2488, 2470, 2471, 2473, 2474, 4393,
				4394
			});
			...
			{
				3665, 48, 3666, 306, 3667, 328, 3668, 625, 3669, 626,
				3670, 627, 3671, 680, 3672, 681, 3673, 831, 3674, 838,
				3675, 914, 3676, 952, 3677, 1142, 3678, 1298, 3679, 1528,
				3680, 1529, 3681, 1530, 3682, 1531, 3683, 1532, 3684, 2230,
				3685, 2249, 3686, 2250, 3687, 2526, 3688, 2544, 3689, 2559,
				3690, 2574, 3691, 2612, 3692, 2613, 3693, 2614, 3694, 2615,
				3695, 2616, 3696, 2617, 3697, 2618, 3698, 2619, 3699, 2620,
				3700, 2748, 3701, 2814, 3703, 3125, 3702, 3180, 3704, 3181,
				3705, 3665, 3706, 3665, 4713, 4712, 5167, 5156, 5188, 5177,
				5209, 5198, 5567, 5556, 5620, 5609, 5708, 5697, 5731, 5720,
				5754, 5745, 5776, 5763, 5797, 5784, 5818, 5805, 5839, 5826,
				5857, 5846, 5878, 5865, 5897, 5886, 5918, 5905, 5952, 5939,
				5974, 5962, 5995, 5982, 6018, 6005, 6041, 6028, 6064, 6051,
				6087, 6074, 6131, 6118
			});
			...
			public static bool[] TrapSigned = ItemID.Sets.Factory.CreateBoolSet(false, new int[]
			{
				...
				3695, 3696, 3697, 3698, 3699, 3700, 3701, 3703, 3702, 3704,
				3705, 3706, 3886, 3887, 3950, 3976, 4164, 4185, 4206, 4227,
				4266, 4268, 4585, 4713, 5167, 5188, 5209, 5567, 5620, 5708,
				5731, 5754, 5776, 5797, 5818, 5839, 5857, 5878, 5897, 5918,
				5952, 5974, 5995, 6018, 6041, 6064, 6087, 6131
			});

			// Token: 0x04006ED8 RID: 28376
			public static bool[] Deprecated = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				2783, 2785, 2782, 2773, 2775, 2772, 2778, 2780, 2777, 3463,
				3465, 3462, 2881, 3847, 3848, 3849, 3850, 3851, 3850, 3861,
				3862, 4010, 4058, 4722, 3978
			});

			// Token: 0x04006ED9 RID: 28377
			public static bool[] NeverAppearsAsNewInInventory = ItemID.Sets.Factory.CreateBoolSet(new int[] { 71, 72, 73, 74 });

			// Token: 0x04006EDA RID: 28378
			public static bool[] CommonCoin = ItemID.Sets.Factory.CreateBoolSet(new int[] { 71, 72, 73, 74 });

			// Token: 0x04006EDB RID: 28379
			public static bool[] ItemIconPulse = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				520, 521, 575, 549, 548, 547, 3456, 3457, 3458, 3459,
				3580, 3581
			});
			...
			{
				520, 521, 575, 549, 548, 547, 3453, 3454, 3455, 3456,
				3457, 3458, 3459, 3580, 3581, 4143
			});

			// Token: 0x04006EDD RID: 28381
			public static int[] ExtractinatorMode = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				424, 0, 1103, 0, 3347, 1, 2339, 2, 2338, 2,
				2337, 2, 4354, 3, 4389, 3, 4377, 3, 4378, 3,
				5127, 3, 5128, 3, 5395, 4, 1124, 5, 4090, 6,
				173, 6
			});
			...
			public static bool[] ExoticPlantsForDyeTrade = ItemID.Sets.Factory.CreateBoolSet(new int[] { 3385, 3386, 3387, 3388 });

			// Token: 0x04006EE0 RID: 28384
			public static bool[] NebulaPickup = ItemID.Sets.Factory.CreateBoolSet(new int[] { 3453, 3454, 3455 });

			// Token: 0x04006EE1 RID: 28385
			public static bool[] AnimatesAsSoul = ItemID.Sets.Factory.CreateBoolSet(new int[] { 575, 547, 520, 548, 521, 549, 3580, 3581 });

			// Token: 0x04006EE2 RID: 28386
			public static bool[] ErrorWorldChestSwapImmunity = ItemID.Sets.Factory.CreateBoolSet(new int[] { 0, 1156, 1571, 1569, 1260, 1572, 4607 });

			// Token: 0x04006EE3 RID: 28387
			public static bool[] gunProj = ItemID.Sets.Factory.CreateBoolSet(new int[] { 3475, 3540, 3854, 3930 });

			// Token: 0x04006EE4 RID: 28388
			public static int[] SortingPriorityMiscAcorns = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				5518, 1, 5438, 2, 4857, 3, 4856, 4, 4855, 5,
				4854, 6, 4853, 7, 4851, 8, 4852, 9, 4907, 10,
				4871, 11, 27, 12
			});
			...
			{
				276, 1, 318, 2, 312, 3, 316, 4, 310, 5,
				2358, 6, 2357, 7, 314, 8, 308, 9, 313, 10,
				307, 11, 317, 12, 311, 13, 315, 14, 309, 15
			});

			// Token: 0x04006EE7 RID: 28391
			public static int[] SortingPriorityMiscBossBags = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				3318, 1, 3319, 2, 3320, 3, 3321, 4, 3323, 5,
				3322, 6, 5111, 7, 3324, 8, 4957, 9, 3325, 10,
				3326, 11, 3327, 12, 3328, 13, 3329, 14, 3330, 15,
				4782, 16, 3331, 17, 3332, 18, 3861, 19, 3862, 20,
				3860, 21
			});
			...
			{
				508, 1, 494, 2, 507, 3, 1305, 4, 4057, 5,
				4372, 6, 4715, 7, 4673, 8, 4063, 9
			});

			// Token: 0x04006EE9 RID: 28393
			public static int[] SortingPriorityToolsFishing = ItemID.Sets.Factory.CreateIntSet(-1, new int[] { 4608, 1 });

			// Token: 0x04006EEA RID: 28394
			public static int[] SortingPriorityToolsGolf = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				4595, 1, 4598, 2, 4597, 3, 4596, 4, 4591, 5,
				4594, 6, 4593, 7, 4592, 8, 4039, 9, 4094, 10,
				4093, 11, 4092, 12, 4587, 13, 4590, 14, 4589, 15,
				4588, 16, 4095, 17
			});
			...
			{
				4367, 1, 4368, 2, 4369, 3, 4370, 4, 4371, 5,
				4379, 6, 4610, 7, 4611, 8, 4612, 9, 4613, 10,
				4648, 11, 4649, 12, 4650, 13, 4651, 14, 4669, 15,
				4670, 16, 4671, 17, 4674, 18, 4675, 19, 4676, 20,
				4677, 21, 4681, 22, 4683, 23, 4684, 24
			});

			// Token: 0x04006EEC RID: 28396
			public static int[] SortingPriorityToolsKeys = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				327, 1, 329, 2, 3092, 3, 3091, 4, 1141, 5,
				1533, 6, 4714, 7, 1537, 8, 1534, 9, 1535, 10,
				1536, 11
			});
			...
			{
				1326, 1, 5335, 2, 3384, 3, 1299, 4, 2272, 5,
				2610, 6, 5495, 7, 1000, 8, 1450, 9, 114, 10,
				5451, 11, 5738, 12, 5644, 13, 3213, 20, 4131, 21,
				5325, 22, 4767, 23, 5453, 24, 5309, 25, 5454, 26,
				5323, 27, 5455, 28, 4346, 29, 5391, 30, 282, 40,
				286, 41, 3112, 42, 3002, 43, 4776, 44, 5643, 45,
				5574, 51, 5575, 52, 5576, 53
			});

			// Token: 0x04006EEE RID: 28398
			public static int[] SortingPriorityWeaponsRanged = ItemID.Sets.Factory.CreateIntSet(-1, new int[] { 905, 1 });

			// Token: 0x04006EEF RID: 28399
			public static int[] SortingPriorityPotionsBuffs = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				678, 1, 2350, 2, 2997, 3, 4870, 4, 2351, 5,
				2756, 6, 2352, 7, 2353, 8
			});

			// Token: 0x04006EF0 RID: 28400
			public static int[] SortingPriorityPotionsDyeMaterial = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				1115, 1, 1114, 2, 1110, 3, 1112, 4, 1108, 5,
				1107, 6, 1116, 7, 1109, 8, 1111, 9, 1118, 10,
				1117, 11, 1113, 12, 1119, 13
			});

			// Token: 0x04006EF1 RID: 28401
			public static int[] SortingPriorityMiscImportants = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				43, 1, 560, 2, 70, 3, 1331, 3, 361, 4,
				5120, 5, 1133, 5, 4988, 6, 5334, 7, 544, 8,
				556, 9, 557, 10, 1315, 11, 2673, 12, 602, 13,
				1844, 14, 1958, 15, 1293, 16, 2767, 17, 4271, 18,
				3601, 19, 1291, 20, 109, 21, 29, 22, 50, 23,
				3199, 24, 3124, 25, 5437, 26, 5358, 27, 5359, 28,
				5360, 29, 5361, 30, 4263, 31, 4819, 32, 5342, 50,
				5341, 51, 5340, 52, 5339, 53, 5338, 54, 5337, 55,
				4910, 56, 4830, 57, 4829, 58, 5343, 59, 5336, 60,
				4382, 61, 5326, 62, 5043, 63, 5289, 64, 3335, 65
			});

			// Token: 0x04006EF2 RID: 28402
			public static int[] SortingPriorityWiring = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				510, 103, 3625, 102, 509, 101, 851, 100, 850, 99,
				3612, 98, 849, 97, 4485, 96, 4484, 95, 583, 94,
				584, 93, 585, 92, 538, 91, 513, 90, 3545, 90,
				853, 89, 541, 88, 529, 88, 1151, 87, 852, 87,
				543, 87, 542, 87, 3707, 87, 2492, 86, 530, 85,
				581, 84, 582, 84, 1263, 83
			});

			// Token: 0x04006EF3 RID: 28403
			public static int[] SortingPriorityMaterials = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				3467, 101, 3460, 100, 3458, 99, 3456, 98, 3457, 97,
				3459, 96, 3261, 95, 1508, 94, 1552, 93, 1006, 92,
				947, 91, 1225, 90, 1198, 89, 1106, 88, 391, 87,
				366, 86, 1191, 85, 1105, 84, 382, 83, 365, 82,
				1184, 81, 1104, 80, 381, 79, 364, 78, 548, 77,
				547, 76, 549, 75, 575, 74, 521, 73, 520, 72,
				175, 71, 173, 70, 174, 69, 3380, 68, 1329, 67,
				1257, 66, 880, 65, 86, 64, 57, 63, 56, 62,
				117, 61, 116, 60, 706, 59, 702, 58, 19, 57,
				13, 56, 705, 55, 701, 54, 21, 53, 14, 52,
				704, 51, 700, 50, 22, 49, 11, 48, 703, 47,
				699, 46, 20, 45, 12, 44
			});

			// Token: 0x04006EF4 RID: 28404
			public static int[] SortingPriorityExtractibles = ItemID.Sets.Factory.CreateIntSet(-1, new int[] { 997, 4, 3347, 3, 1103, 2, 424, 1 });

			// Token: 0x04006EF5 RID: 28405
			public static int[] SortingPriorityRopes = ItemID.Sets.Factory.CreateIntSet(-1, new int[] { 965, 1, 85, 1, 2996, 1, 3077, 1, 3078, 1 });

			// Token: 0x04006EF6 RID: 28406
			public static int[] SortingPriorityPainting = ItemID.Sets.Factory.CreateIntSet(-1, new int[]
			{
				1543, 100, 1544, 99, 1545, 98, 1071, 97, 1072, 96,
				1100, 95
			});
			...
			{
				5134, 100, 779, 99, 780, 98, 783, 97, 781, 96,
				782, 95, 784, 94, 5392, 93, 5393, 92, 5394, 91,
				422, 90, 423, 89, 3477, 88, 66, 67, 67, 86,
				2886, 85, 5304, 84, 5303, 83, 4872, 82, 3032, 81,
				5364, 80, 5302, 79, 1128, 78, 4820, 77, 207, 76,
				3031, 75, 206, 74, 205, 73, 5542, 72, 4909, 71,
				4908, 70, 4827, 69, 4826, 68, 4825, 67, 4824, 66,
				580, 64, 5595, 63, 5594, 62, 3547, 61, 2896, 60,
				167, 59, 4423, 58, 3196, 57, 3115, 56, 235, 55,
				166, 54
			});
			...
			{
				2797, 20, 3278, 4, 3285, 6, 3279, 8, 3280, 8,
				3281, 9, 3262, 10, 3317, 10, 5294, 10, 3282, 10,
				3315, 10, 3316, 11, 3283, 12, 3290, 13, 3289, 11,
				3284, 13, 3286, 13, 3287, 18, 3288, 18, 3291, 17,
				3292, 18, 3389, 21
			});
			...
			{
				1326, 5335, 1256, 1244, 3014, 113, 218, 495, 114, 496,
				65, 1931, 3570, 2750, 3065, 3029, 3030, 4381, 4956, 5669,
				5065, 2796, 494, 3006, 4715, 1309, 2364, 2365, 2551, 2535,
				2584, 1157, 2749, 1802, 2621, 3249, 3531, 3474, 2366, 1572,
				3569, 3571, 4269, 4273, 4281, 5119, 5456, 5463, 5663, 5664,
				3611, 1299, 1254
			});

			// Token: 0x04006EFA RID: 28410
			public static float[] BonusMeleeSpeedMultiplier = ItemID.Sets.Factory.CreateFloatSet(1f, new float[] { 1827f, 0.5f, 3013f, 0.25f, 3106f, 0.33f, 757f, 0.75f });

			// Token: 0x04006EFB RID: 28411
			public static bool[] GamepadSmartQuickReach = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				2798, 2797, 3030, 3262, 3278, 3279, 3280, 3281, 3282, 3283,
				3284, 3285, 3286, 3287, 3288, 3289, 3290, 3291, 3292, 3315,
				3316, 3317, 5294, 3389, 2798, 65, 1931, 3570, 2750, 3065,
				3029, 4956, 5669, 5065, 1256, 1244, 3014, 113, 218, 495
			});

			// Token: 0x04006EFC RID: 28412
			public static bool[] Yoyo = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				3262, 3278, 3279, 3280, 3281, 3282, 3283, 3284, 3285, 3286,
				3287, 3288, 3289, 3290, 3291, 3292, 3315, 3316, 3317, 3389,
				5294
			});
			...
			{
				3031, 205, 1128, 207, 206, 3032, 849, 3620, 509, 851,
				850, 3625, 510, 1071, 1543, 1072, 1544, 1100, 1545, 4820,
				4872, 5303, 5304, 5302, 5364
			});

			// Token: 0x04006EFE RID: 28414
			public static bool[] NeverLocksOn = ItemID.Sets.Factory.CreateBoolSet(new int[] { 496, 1326, 5335 });

			// Token: 0x04006EFF RID: 28415
			public static bool[] LockOnIgnoresCollision = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				64, 3570, 1327, 3006, 1227, 788, 756, 1228, 65, 3065,
				3473, 3051, 5065, 1309, 2364, 2365, 2551, 2535, 2584, 1157,
				2749, 1802, 2621, 3249, 3531, 3474, 2366, 1572, 4269, 4273,
				4281, 4607, 5069, 5114, 5119, 5456, 5463, 5663, 5664, 3014,
				3569, 3571
			});

			// Token: 0x04006F00 RID: 28416
			public static int[] LockOnAimAbove = ItemID.Sets.Factory.CreateIntSet(0, new int[] { 1256, 15, 1244, 15, 3014, 15, 3569, 15, 3571, 15 });

			// Token: 0x04006F01 RID: 28417
			public static float?[] LockOnAimCompensation = ItemID.Sets.Factory.CreateCustomSet<float?>(null, new object[] { 1336, 0.2f, 157, 0.29f, 2590, 0.4f, 3821, 0.4f, 160, 0.4f });

			// Token: 0x04006F02 RID: 28418
			public static bool[] SingleUseInGamepad = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				8, 427, 3004, 523, 433, 429, 974, 1333, 1245, 3114,
				430, 3045, 428, 2274, 431, 432, 4383, 4384, 4385, 4386,
				4387, 4388, 5293, 5353
			});
			...
			public static bool[] WaterTorches = ItemID.Sets.Factory.CreateBoolSet(new int[] { 523, 1333, 4384 });

			// Token: 0x04006F05 RID: 28421
			public static bool[] Campfires = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				966, 3724, 4690, 4691, 4692, 3046, 3047, 4689, 3048, 4693,
				3049, 4694, 5299, 3050, 5357, 3723
			});

			// Token: 0x04006F06 RID: 28422
			public static bool[] Glowsticks = ItemID.Sets.Factory.CreateBoolSet(new int[] { 282, 286, 3112, 3002, 4776, 5643 });
			...
			public static bool[] BossBag = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				...
				3328, 3329, 3330, 3331, 3332, 3860, 3861, 3862, 4782, 4957,
				5111
			});
			...
			public static bool[] OpenableBag = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				3318, 3319, 3320, 3321, 3322, 3323, 3324, 3325, 3326, 3327,
				3328, 3329, 3330, 3331, 3332, 3860, 3861, 3862, 4782, 4957,
				5111, 2334, 2335, 2336, 3203, 3204, 3205, 3206, 3207, 3208,
				4405, 4407, 4877, 5002, 3979, 3980, 3981, 3982, 3983, 3984,
				3985, 3986, 3987, 4406, 4408, 4878, 5003, 3093, 4345, 4410,
				1774, 6142, 3085, 4879, 1869, 599, 600, 601
			});

			// Token: 0x04006F0A RID: 28426
			public static bool[] HasItemSwap = ItemID.Sets.Factory.CreateBoolSet(new int[]
			{
				5325, 4131, 5060, 5059, 5324, 5329, 5330, 4346, 5391, 5323,
				5455, 4767, 5453, 5309, 5454, 5358, 5360, 5361, 5359, 5437,
				2611, 5526
			});
			...
			{
				1522, true, 1523, true, 1524, true, 1525, true, 1526, true,
				1527, true, 3643, true, 3103, true, 3104, true, 856, true,
				1299, true, 329, true, 4346, true, 5391, true, 4767, true,
				5453, true, 5309, true, 5454, true, 5323, true, 5455, true,
				205, false, 206, false, 207, false, 1128, false, 267, false,
				849, false
			});
			...
			{
				4346, 5391, 5323, 5455, 4767, 5453, 5309, 5454, 4131, 5325,
				5358, 5359, 5360, 5361, 3384, 3823, 3858, 4760, 3852, 4367,
				4368, 4369, 4370, 4371, 4379, 4610, 4611, 4612, 4613, 4648,
				4649, 4650, 4651, 4669, 4670, 4671, 4673, 4674, 4675, 4676,
				4677, 4681, 4683, 4684, 2611, 5526
			});
			...
			public static bool?[] CanPassivelyStackInWorldOverride = ItemID.Sets.Factory.CreateCustomSet<bool?>(null, new object[]
			{
				...
				205, true, 206, true, 207, true, 1128, true, 530, true
			});

			// Token: 0x04006F0F RID: 28431
			public static bool[] IsRangedSpecialistWeapon = ItemID.Sets.Factory.CreateBoolSet(new int[] { 1156, 3350, 3210, 160, 266, 5629, 3821, 5460 });
			...
			{
				441, 449, 466, 471, 3651, 3652, 3653, 3654, 3655, 3656,
				3657, 3658, 3659, 3660, 3661, 3662, 3708, 3709, 3710, 3711,
				3712, 3713, 3714, 3715, 3716, 3717, 3718, 3719, 3720, 4397,
				4360, 4342, 4466, 5317, 5318, 5319, 440, 443, 444, 445,
				446, 452, 454, 459, 463, 464, 478, 473, 2672, 438,
				453, 476, 477, 470, 4355, 4276
			});
		}
	}
}
