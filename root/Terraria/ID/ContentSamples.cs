...
namespace Terraria.ID
{
	...
	{
		// Token: 0x06001F01 RID: 7937 RVA: 0x00512248 File Offset: 0x00510448
		...
		// Token: 0x06001F02 RID: 7938 RVA: 0x0051242C File Offset: 0x0051062C
		private static void FillResearchItemOverrides()
		{
			ContentSamples.AddItemResearchOverride(4131, new int[] { 5325 });
			ContentSamples.AddItemResearchOverride(5324, new int[] { 5329, 5330 });
			ContentSamples.AddItemResearchOverride(5437, new int[] { 5358, 5359, 5360, 5361 });
			ContentSamples.AddItemResearchOverride(4346, new int[] { 5391 });
			ContentSamples.AddItemResearchOverride(4767, new int[] { 5453 });
			ContentSamples.AddItemResearchOverride(5309, new int[] { 5454 });
			ContentSamples.AddItemResearchOverride(5323, new int[] { 5455 });
			ContentSamples.AddItemResearchOverride(5526, new int[] { 2611 });
		}

		// Token: 0x06001F03 RID: 7939 RVA: 0x00512504 File Offset: 0x00510704
		...
		// Token: 0x06001F04 RID: 7940 RVA: 0x00512528 File Offset: 0x00510728
		...
		// Token: 0x06001F05 RID: 7941 RVA: 0x00512538 File Offset: 0x00510738
		...
		// Token: 0x06001F06 RID: 7942 RVA: 0x00512590 File Offset: 0x00510790
		...
		// Token: 0x06001F07 RID: 7943 RVA: 0x005126BD File Offset: 0x005108BD
		...
		// Token: 0x06001F08 RID: 7944 RVA: 0x005126CF File Offset: 0x005108CF
		...
		// Token: 0x06001F09 RID: 7945 RVA: 0x005126E0 File Offset: 0x005108E0
		private static void ModifyNPCIds()
		{
			...
			{
				npcBestiaryCreditIdsByNpcNetIds[i] = npcBestiaryCreditIdsByNpcNetIds[(int)num];
			}
		...
		// Token: 0x06001F0A RID: 7946 RVA: 0x00512F48 File Offset: 0x00511148
		...
		// Token: 0x06001F0B RID: 7947 RVA: 0x00512FAC File Offset: 0x005111AC
		private static void FillNpcRarities()
		{
			NPCSpawnParams npcspawnParams = new NPCSpawnParams
			{
			...
			{
				NPC npc = new NPC();
				npc.SetDefaults(i, npcspawnParams);
		...
		// Token: 0x06001F0C RID: 7948 RVA: 0x00513854 File Offset: 0x00511A54
		...
		// Token: 0x06001F0D RID: 7949 RVA: 0x0051397F File Offset: 0x00511B7F
		private static void CreateCreativeItemSortingIds()
		{
			ContentSamples.CreativeHelper.SetCreativeMenuOrder();
		}

		// Token: 0x06001F0E RID: 7950 RVA: 0x00513988 File Offset: 0x00511B88
		...
		{
			// Token: 0x06004104 RID: 16644 RVA: 0x0069F1F4 File Offset: 0x0069D3F4
			public static void Initialize()
			{
			...
			// Token: 0x06004105 RID: 16645 RVA: 0x0069F21E File Offset: 0x0069D41E
			// Note: this type is marked as 'beforefieldinit'.
			static DyeShaderIDs()
			{
			}
		...
		{
			// Token: 0x06004106 RID: 16646 RVA: 0x0069F22C File Offset: 0x0069D42C
			public static ContentSamples.CreativeHelper.ItemGroup GetItemGroup(Item item, out int orderInGroup)
			{
				...
				if (item.createTile >= 0)
				{
					...
					return ContentSamples.CreativeHelper.ItemGroup.PlaceableObjects;
				}
			...
			// Token: 0x06004107 RID: 16647 RVA: 0x006A014C File Offset: 0x0069E34C
			...
			// Token: 0x06004108 RID: 16648 RVA: 0x006A02A0 File Offset: 0x0069E4A0
			...
			// Token: 0x06004109 RID: 16649 RVA: 0x006A02C0 File Offset: 0x0069E4C0
			// Note: this type is marked as 'beforefieldinit'.
			...
			{
				// Token: 0x06004BD2 RID: 19410 RVA: 0x006D95B6 File Offset: 0x006D77B6
			...
			{
				// Token: 0x06004BD3 RID: 19411 RVA: 0x006D95D6 File Offset: 0x006D77D6
				// Note: this type is marked as 'beforefieldinit'.
				static <>c()
				{
				}

				// Token: 0x06004BD4 RID: 19412 RVA: 0x0000357B File Offset: 0x0000177B
				public <>c()
				{
				}

				// Token: 0x06004BD5 RID: 19413 RVA: 0x006D95E2 File Offset: 0x006D77E2
				internal ContentSamples.CreativeHelper.ItemGroupAndOrderInGroup <SetCreativeMenuOrder>b__7_0(Item x)
				{
					return new ContentSamples.CreativeHelper.ItemGroupAndOrderInGroup(x);
				}

				// Token: 0x06004BD6 RID: 19414 RVA: 0x006D95EA File Offset: 0x006D77EA
				...
				// Token: 0x06004BD7 RID: 19415 RVA: 0x006D95F2 File Offset: 0x006D77F2
				...
				// Token: 0x06004BD8 RID: 19416 RVA: 0x006D95FA File Offset: 0x006D77FA
				...
				{
					return group.ToList<ContentSamples.CreativeHelper.ItemGroupAndOrderInGroup>();
				}

				// Token: 0x040077C0 RID: 30656
				public static readonly ContentSamples.CreativeHelper.<>c <>9 = new ContentSamples.CreativeHelper.<>c();
		...
		{
			// Token: 0x0600410A RID: 16650 RVA: 0x006A0714 File Offset: 0x0069E914
			...
			// Token: 0x0600410B RID: 16651 RVA: 0x006A08A0 File Offset: 0x0069EAA0
			...
			// Token: 0x0600410C RID: 16652 RVA: 0x006A08EC File Offset: 0x0069EAEC
			...
			// Token: 0x0600410D RID: 16653 RVA: 0x006A0915 File Offset: 0x0069EB15
			public static float GetBestiaryPowerLevel(NPC npc)
			{
				return (float)(npc.damage + npc.defense + npc.lifeMax / 4);
			}

			// Token: 0x0600410E RID: 16654 RVA: 0x006A0930 File Offset: 0x0069EB30
			...
			// Token: 0x0600410F RID: 16655 RVA: 0x006A095C File Offset: 0x0069EB5C
			...
			// Token: 0x06004110 RID: 16656 RVA: 0x006A0985 File Offset: 0x0069EB85
			public static int GetBestiaryBossPriority(NPC npc)
			{
				return NPCID.Sets.BossBestiaryPriority.IndexOf(npc.netID);
			}

			// Token: 0x06004111 RID: 16657 RVA: 0x006A0997 File Offset: 0x0069EB97
			...
			{
				// Token: 0x06004BD9 RID: 19417 RVA: 0x0000357B File Offset: 0x0000177B
				public <>c__DisplayClass0_0()
				{
				}

				// Token: 0x06004BDA RID: 19418 RVA: 0x006D9602 File Offset: 0x006D7802
				internal int <GetSortedBestiaryEntriesList>b__5(KeyValuePair<int, NPC> x)
				{
					return ContentSamples.BestiaryHelper.GetLowestBiomeGroupIndex(x.Value, this.database, this.commonFilters);
				}
			...
			private sealed class <>c
			{
				// Token: 0x06004BDB RID: 19419 RVA: 0x006D961C File Offset: 0x006D781C
				// Note: this type is marked as 'beforefieldinit'.
				static <>c()
				{
				}

				// Token: 0x06004BDC RID: 19420 RVA: 0x0000357B File Offset: 0x0000177B
				public <>c()
				{
				}

				// Token: 0x06004BDD RID: 19421 RVA: 0x006D9628 File Offset: 0x006D7828
				internal int <GetSortedBestiaryEntriesList>b__0_0(KeyValuePair<int, NPC> x)
				{
					return ContentSamples.BestiaryHelper.GetBestiaryTownPriority(x.Value);
				}

				// Token: 0x06004BDE RID: 19422 RVA: 0x006D9636 File Offset: 0x006D7836
				internal bool <GetSortedBestiaryEntriesList>b__0_1(KeyValuePair<int, NPC> x)
				{
					return !x.Value.isLikeATownNPC;
				}

				// Token: 0x06004BDF RID: 19423 RVA: 0x006D9647 File Offset: 0x006D7847
				internal int <GetSortedBestiaryEntriesList>b__0_2(KeyValuePair<int, NPC> x)
				{
					return ContentSamples.BestiaryHelper.GetBestiaryNormalGoldCritterPriority(x.Value);
				}

				// Token: 0x06004BE0 RID: 19424 RVA: 0x006D9655 File Offset: 0x006D7855
				internal bool <GetSortedBestiaryEntriesList>b__0_3(KeyValuePair<int, NPC> x)
				{
					return !x.Value.CountsAsACritter;
				}

				// Token: 0x06004BE1 RID: 19425 RVA: 0x006D9666 File Offset: 0x006D7866
				internal int <GetSortedBestiaryEntriesList>b__0_4(KeyValuePair<int, NPC> x)
				{
					return ContentSamples.BestiaryHelper.GetBestiaryBossPriority(x.Value);
				}

				// Token: 0x06004BE2 RID: 19426 RVA: 0x006D9674 File Offset: 0x006D7874
				internal int <GetSortedBestiaryEntriesList>b__0_6(KeyValuePair<int, NPC> x)
				{
					return x.Value.aiStyle;
				}

				// Token: 0x06004BE3 RID: 19427 RVA: 0x006D9682 File Offset: 0x006D7882
				internal float <GetSortedBestiaryEntriesList>b__0_7(KeyValuePair<int, NPC> x)
				{
					return ContentSamples.BestiaryHelper.GetBestiaryPowerLevel(x.Value);
				}

				// Token: 0x06004BE4 RID: 19428 RVA: 0x006D9690 File Offset: 0x006D7890
				internal int <GetSortedBestiaryEntriesList>b__0_8(KeyValuePair<int, NPC> x)
				{
					return ContentSamples.BestiaryHelper.GetBestiaryStarsPriority(x.Value);
				}

				// Token: 0x06004BE5 RID: 19429 RVA: 0x006D969E File Offset: 0x006D789E
				internal bool <GetSortedBestiaryEntriesList>b__0_9(KeyValuePair<int, NPC> x)
				{
					return ContentSamples.BestiaryHelper.ShouldHideBestiaryEntry(x.Value);
				}

				// Token: 0x040077C7 RID: 30663
				public static readonly ContentSamples.BestiaryHelper.<>c <>9 = new ContentSamples.BestiaryHelper.<>c();
				...
				public static Func<KeyValuePair<int, NPC>, int> <>9__0_6;

				// Token: 0x040077CE RID: 30670
				public static Func<KeyValuePair<int, NPC>, float> <>9__0_7;

				// Token: 0x040077CF RID: 30671
				public static Func<KeyValuePair<int, NPC>, int> <>9__0_8;

				// Token: 0x040077D0 RID: 30672
				public static Predicate<KeyValuePair<int, NPC>> <>9__0_9;
			}
		}
	}
}
