...
namespace Terraria.UI
{
	...
	public class AchievementAdvisor
	{
		...
		// (get) Token: 0x060018D8 RID: 6360 RVA: 0x004E53F8 File Offset: 0x004E35F8
		...
		// Token: 0x060018D9 RID: 6361 RVA: 0x004E5417 File Offset: 0x004E3617
		public AchievementAdvisor()
		{
		}

		// Token: 0x060018DA RID: 6362 RVA: 0x004E542C File Offset: 0x004E362C
		...
		// Token: 0x060018DB RID: 6363 RVA: 0x00009E46 File Offset: 0x00008046
		public void Draw(SpriteBatch spriteBatch)
		{
		}

		// Token: 0x060018DC RID: 6364 RVA: 0x004E5494 File Offset: 0x004E3694
		...
		// Token: 0x060018DD RID: 6365 RVA: 0x004E5546 File Offset: 0x004E3746
		public void Update()
		{
			this._hoveredCard = null;
		}

		// Token: 0x060018DE RID: 6366 RVA: 0x004E5550 File Offset: 0x004E3750
		...
		// Token: 0x060018DF RID: 6367 RVA: 0x004E5658 File Offset: 0x004E3858
		...
		// Token: 0x060018E0 RID: 6368 RVA: 0x004E56D4 File Offset: 0x004E38D4
		private void DrawCard(AchievementAdvisorCard card, SpriteBatch spriteBatch, Vector2 position, float scale, out bool hovered)
		{
			...
			Texture2D texture2D = this._achievementsBorderMouseHoverFatTexture.Value;
			if (scale > 0.5f)
			{
				texture2D = this._achievementsBorderMouseHoverThinTexture.Value;
			...
			spriteBatch.Draw(this._achievementsBorderTexture.Value, position + vector, null, white, 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
			if (hovered)
			{
				spriteBatch.Draw(texture2D, position + vector2, null, Main.OurFavoriteColor, 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
			}
		}

		// Token: 0x060018E1 RID: 6369 RVA: 0x004E584C File Offset: 0x004E3A4C
		...
		// Token: 0x060018E2 RID: 6370 RVA: 0x004E58A8 File Offset: 0x004E3AA8
		public void Initialize()
		{
			...
			this._cards.OrderBy((AchievementAdvisorCard x) => x.order);
		}
		...
		{
			// Token: 0x06003FE1 RID: 16353 RVA: 0x0069C175 File Offset: 0x0069A375
			// Note: this type is marked as 'beforefieldinit'.
			static <>c()
			{
			}

			// Token: 0x06003FE2 RID: 16354 RVA: 0x0000357B File Offset: 0x0000177B
			public <>c()
			{
			}

			// Token: 0x06003FE3 RID: 16355 RVA: 0x0069C181 File Offset: 0x0069A381
			internal float <Initialize>b__17_0(AchievementAdvisorCard x)
			{
				return x.order;
			}

			// Token: 0x04006860 RID: 26720
			public static readonly AchievementAdvisor.<>c <>9 = new AchievementAdvisor.<>c();

			// Token: 0x04006861 RID: 26721
			public static Func<AchievementAdvisorCard, float> <>9__17_0;
		}
	}
}
