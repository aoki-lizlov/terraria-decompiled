...
namespace Terraria.Map
{
	...
	{
		// Token: 0x06001E4C RID: 7756 RVA: 0x00504954 File Offset: 0x00502B54
		public static void Initialize()
		{
			...
			for (int num8 = 0; num8 < array5.Length; num8++)
			{
				...
				float num10 = 1f - num9;
				array5[num8] = new Color((int)((byte)((float)color6.R * num10 + (float)color7.R * num9)), (int)((byte)((float)color6.G * num10 + (float)color7.G * num9)), (int)((byte)((float)color6.B * num10 + (float)color7.B * num9)));
			}
			...
			for (int num11 = 0; num11 < array6.Length; num11++)
			{
				...
				array6[num11] = new Color((int)((byte)((float)color8.R * num13 + (float)color9.R * num12)), (int)((byte)((float)color8.G * num13 + (float)color9.G * num12)), (int)((byte)((float)color8.B * num13 + (float)color9.B * num12)));
			}
			...
			for (int num14 = 0; num14 < array7.Length; num14++)
			{
				...
				array7[num14] = new Color((int)((byte)((float)color10.R * num16 + (float)color9.R * num15)), (int)((byte)((float)color10.G * num16 + (float)color9.G * num15)), (int)((byte)((float)color10.B * num16 + (float)color9.B * num15)));
			}
			Color color11 = new Color(50, 44, 38);
			int num17 = 0;
			MapHelper.tileOptionCounts = new int[(int)TileID.Count];
			for (int num18 = 0; num18 < (int)TileID.Count; num18++)
			{
				Color[] array8 = array[num18];
				int num19 = 0;
				while (num19 < 13 && !(array8[num19] == Color.Transparent))
				{
					num19++;
				}
			...
			for (int num20 = 0; num20 < (int)WallID.Count; num20++)
			{
				Color[] array9 = array4[num20];
				int num21 = 0;
				while (num21 < 2 && !(array9[num21] == Color.Transparent))
				{
					num21++;
				}
			...
			MapHelper.colorLookup[(int)num22] = color11;
		...
		// Token: 0x06001E51 RID: 7761 RVA: 0x0050CE78 File Offset: 0x0050B078
		...
		// Token: 0x06001E52 RID: 7762 RVA: 0x0050CFE8 File Offset: 0x0050B1E8
		public static Color GetMapTileXnaColor(MapTile tile)
		{
			Color color = MapHelper.colorLookup[(int)tile.Type];
			byte color2 = tile.Color;
			if (color2 > 0)
			{
				MapHelper.MapColor(tile.Type, ref color, color2);
			}
			if (tile.Light == 255)
			{
				return color;
		...
		// Token: 0x06001E53 RID: 7763 RVA: 0x0050D074 File Offset: 0x0050B274
		public static bool IsBackground(int mapType)
		{
			return mapType >= (int)MapHelper.skyPosition;
		}

		// Token: 0x06001E54 RID: 7764 RVA: 0x0050D084 File Offset: 0x0050B284
		...
		// Token: 0x06001E55 RID: 7765 RVA: 0x0050D100 File Offset: 0x0050B300
		...
		// Token: 0x06001E56 RID: 7766 RVA: 0x0050D200 File Offset: 0x0050B400
		...
		// Token: 0x06001E57 RID: 7767 RVA: 0x0050D2BC File Offset: 0x0050B4BC
		...
		// Token: 0x06001E58 RID: 7768 RVA: 0x0050D3C4 File Offset: 0x0050B5C4
		...
		// Token: 0x06001E59 RID: 7769 RVA: 0x0050D3E4 File Offset: 0x0050B5E4
		...
		// Token: 0x06001E5A RID: 7770 RVA: 0x0050E2C4 File Offset: 0x0050C4C4
		...
		// Token: 0x06001E5B RID: 7771 RVA: 0x0050E380 File Offset: 0x0050C580
		...
		// Token: 0x06001E5C RID: 7772 RVA: 0x0050EA50 File Offset: 0x0050CC50
		...
		// Token: 0x06001E5D RID: 7773 RVA: 0x0050EAD4 File Offset: 0x0050CCD4
		...
		// Token: 0x06001E5E RID: 7774 RVA: 0x0050F0C8 File Offset: 0x0050D2C8
		...
		// Token: 0x06001E5F RID: 7775 RVA: 0x0050F47C File Offset: 0x0050D67C
		...
		// Token: 0x06001E60 RID: 7776 RVA: 0x0050FAD6 File Offset: 0x0050DCD6
		...
		{
			// Token: 0x060040E9 RID: 16617 RVA: 0x0069EE2A File Offset: 0x0069D02A
			public bool active()
			{
				return (this.misc & 1) == 1;
			}

			// Token: 0x060040EA RID: 16618 RVA: 0x0069EE3A File Offset: 0x0069D03A
			public bool water()
			{
				return (this.misc & 2) == 2;
			}

			// Token: 0x060040EB RID: 16619 RVA: 0x0069EE4A File Offset: 0x0069D04A
			public bool lava()
			{
				return (this.misc & 4) == 4;
			}

			// Token: 0x060040EC RID: 16620 RVA: 0x0069EE5A File Offset: 0x0069D05A
			public bool honey()
			{
				return (this.misc2 & 64) == 64;
			}

			// Token: 0x060040ED RID: 16621 RVA: 0x0069EE6C File Offset: 0x0069D06C
			public bool changed()
			{
				return (this.misc & 8) == 8;
			}

			// Token: 0x060040EE RID: 16622 RVA: 0x0069EE7C File Offset: 0x0069D07C
			public bool wall()
			{
				return (this.misc & 16) == 16;
			}

			// Token: 0x060040EF RID: 16623 RVA: 0x0069EE90 File Offset: 0x0069D090
			public byte option()
			{
				byte b = 0;
				if ((this.misc & 32) == 32)
			...
			// Token: 0x060040F0 RID: 16624 RVA: 0x0069EEEC File Offset: 0x0069D0EC
			public byte color()
			{
